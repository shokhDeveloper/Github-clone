        ...
        <div className="header__inner">
          ...
          <div className="header__child-box">
            ...
            <div className="header__elements">
              <Button active={true} className="header__new_repo">
                +{" "}
                <svg
                  fill="#6e7781"
                  aria-hidden="true"
              ...
              <Button active={true} className="header__issues">
                <svg
                  fill="#6e7781"
                  aria-hidden="true"
                  height="16"
              ...
              <Button active={true} className="header__requests">
                <svg
                  fill="#6e7781"
                  aria-hidden="true"
                  height="16"
              ...
              <Button active={true} className="header__nofications">
                <svg
                fill="#6e7781"
                  aria-hidden="true"
                  height="16"
              ...
              <ProfileBtn onClick={() => dispatch(setProfileBar(true))}
                className="header__account_btn"
                style={{
                  backgroundImage: `url(${
                    profileData?.length ? profileData[0].avatar_url : null
                  } `,
                }}
              ></ProfileBtn>
            </div>
